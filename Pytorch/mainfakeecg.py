...
X_test = torch.tensor(np.load("Pytorch/x_test.npy"), dtype=torch.float32).to(device)
y_test = np.load("Pytorch/y_test.npy")  # No en tensor para manipular índices
...
#---------------------------------------------------------------------------------------------------------
Persona = "72" # SI ES < 10 PONER 0 DELANTE
#---------------------------------------------------------------------------------------------------------
